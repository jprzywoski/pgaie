...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        g_Controller = new CController(cxClient, cyClient, constNumCellsAcross, constNumCellsDown, constNumIterations);
    }
    ...
    case WM_KEYUP:
    {
        ...
        case 'R':
        {
            ...
            g_Controller =
                new CController(cxClient, cyClient, constNumCellsAcross, constNumCellsDown, constNumIterations);
        }
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
    ...
    hWnd = CreateWindowEx(NULL,                // extended style
                          ...
                          GetSystemMetrics(SM_CYSCREEN) / 2 - constWindowHeight / 2, rect.right, // initial x size
