...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT msg, WPARAM wparam, LPARAM lparam)
{
    ...
    case WM_CREATE:
    {
        ...
        g_Controller.Init(cyClient, cxClient, NUM_TIDDLYWINKS, MIN_RAD, MAX_RAD);
    }
...
int WINAPI WinMain(HINSTANCE hinstance, HINSTANCE hprevinstance, LPSTR lpcmdline, int ncmdshow)
{
    ...
    // create the window
    if (!(hwnd = CreateWindowEx(NULL, szWindowClassName, szApplicationName, WS_OVERLAPPED | WS_VISIBLE | WS_CAPTION |
                                WS_SYSMENU, GetSystemMetrics(SM_CXSCREEN) / 2 - WINDOW_WIDTH / 2, GetSystemMetrics(SM_CYSCREEN) / 2 -
                                WINDOW_HEIGHT / 2, WINDOW_WIDTH, WINDOW_HEIGHT, NULL, NULL, hinstance, NULL)))
    {
        return 0;
    }
