...
//
// ------------------------------------------------------------------------
SGenome::SGenome(const int num_bits, const int gene_size): dFitness(0), iGeneLength(gene_size)
{
...
// baby2.
// ---------------------------------------------------------------------
void Cga::Crossover(const vector<int> &mum, const vector<int> &dad, vector<int> &baby1, vector<int> &baby2)
{
...
// --------------------------------------------------------------------
void Cga::GrabNBest(int NBest, const int NumCopies, vector<SGenome> &vecNewPop)
{
