...
void ResizeToCorrectClientArea(HWND hwnd, int AccumulativeToolbarHeight, RECT ClientArea)
{
    ...
    SetWindowPos(hwnd, NULL, 0, 0, ClientArea.right, ClientArea.bottom + AccumulativeToolbarHeight, SWP_NOMOVE |
                 SWP_NOZORDER);
}
...
HWND CreateToolBar(HWND hwndParent, HINSTANCE hinstMain)
{
    ...
    // create the toolbar
    HWND hwndToolBar = CreateWindowEx(NULL, TOOLBARCLASSNAME, (LPSTR)NULL, WS_CHILD | WS_VISIBLE | CCS_BOTTOM, 0, 0, 0,
                                      0, hwndParent, (HMENU)IDR_TOOLBAR1, hinstMain, NULL);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR szCmdLine, int iCmdShow)
{
    ...
    hWnd = CreateWindowEx(NULL,                                 // extended style
                          ...
                          GetSystemMetrics(SM_CXSCREEN) / 2 - WindowWidth / 2, GetSystemMetrics(SM_CYSCREEN) / 2 - WindowHeight / 2,
