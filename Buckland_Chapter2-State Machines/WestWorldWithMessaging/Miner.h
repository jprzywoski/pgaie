...
class State;                            // pre-fixed with "template <class entity_type> " for vs8 compatibility
...
public:
    Miner(int id): m_Location(shack), m_iGoldCarried(0), m_iMoneyInBank(0), m_iThirst(0), m_iFatigue(0), BaseGameEntity(
            id)
    {
